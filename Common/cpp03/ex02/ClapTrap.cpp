...
{
	std::cout << "ClapTrap " << m_name << " constructor is called." << std::endl;
}
...
ClapTrap& ClapTrap::operator = (const ClapTrap& ct)
{
	...
	else
	{
		...
		m_energyPoint = ct.getEnergyPoint();
		m_attackDamage = ct.getAttackDamage();
		std::cout << "ClapTrap " << m_name << " is assigned." << std::endl;
	}
	return *this;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "ClapTrap " << m_name << " destructor is called." << std::endl;
}
...
{
	std::cout << "ClapTrap " << m_name << " got " << amount << "-damage, and ";
